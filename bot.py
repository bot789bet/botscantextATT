...
def button(update,context):
    ...
    data=requests.get(f"https://apipro2.ocr.space/parse/imageurl?apikey={API_KEY}&url={filepath}&language={query.data}&detectOrientation=True&filetype=JPG&OCREngine=3&isTable=True&scale=True")
    data=data.json()
